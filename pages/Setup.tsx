...
import { ShieldCheck, AlertCircle, Loader2, Search, Building } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden max-w-2xl w-full flex flex-col max-h-[90vh]">
        ...
        {error && (
          <div className="bg-red-50 text-red-600 p-3 mx-4 mt-4 rounded-lg text-sm flex items-center gap-2 justify-center">
          ...
          {loadingList ? (
            ...
            filteredCondos.map(condo => (
              <button
                ...
                className={`text-left p-4 rounded-xl border-2 transition-all flex items-start gap-3 hover:shadow-md ${
