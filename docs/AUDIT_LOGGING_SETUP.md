...
⚠️ **Database Required**: You need to run the SQL migration to create the audit_logs table
...
3. Open the file: `src/database/add_audit_logging.sql`
...
- ✅ Example trigger for automatic logging (commented out)
...
VALUES
  ...
  (1, 2, 'CREATE', 'visits', 123, '{"visitor_name": "João Silva", "unit": "A-101"}'),
